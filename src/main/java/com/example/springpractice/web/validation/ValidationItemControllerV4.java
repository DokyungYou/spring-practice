...
import com.example.springpractice.web.validation.form.ItemUpdateForm;
...
public class ValidationItemControllerV4 {
    ...
    @PostMapping("/add")
    public String addItem(@Validated @ModelAttribute("item") ItemSaveForm form, // @Validated : 자동으로 검증기를 실행하는 어노테이션
